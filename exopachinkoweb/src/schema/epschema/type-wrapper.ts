...
import { Message, unionToMessage, unionListToMessage } from '../epschema/message.js';
...
static getRootAsTypeWrapper(bb:flatbuffers.ByteBuffer, obj?:TypeWrapper):TypeWrapper {
  return (obj || new TypeWrapper()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsTypeWrapper(bb:flatbuffers.ByteBuffer, obj?:TypeWrapper):TypeWrapper {
...
static finishTypeWrapperBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset);
}

static finishSizePrefixedTypeWrapperBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, undefined, true);
}

static createTypeWrapper(builder:flatbuffers.Builder, messageType:Message, messageOffset:flatbuffers.Offset):flatbuffers.Offset {
